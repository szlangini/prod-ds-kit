...
MonetDB 11.55.7) — no manual setup. If an engine cannot be installed, the run
...
Paper-faithful by default: **1 untimed warmup query per suite + 10 timed repetitions, median
