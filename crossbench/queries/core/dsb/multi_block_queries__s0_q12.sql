with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('1998-02-28','1998-04-03','1998-08-19','1998-11-18')))
 ...
 and sr_reason_sk in (2, 8, 31, 38, 73)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (2, 8, 31, 38, 73)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (2, 8, 31, 38, 73)
 group by i_item_id)
