select 
 ...
 where
  ...
  ca_county in ('Cabell County','Fresno County','Lander County','Orange County','Roane County') and
  c.c_birth_month in (2, 9) and
  cd_demo_sk = c.c_current_cdemo_sk
  and cd_marital_status in ('M', 'S', 'M')
  and cd_education_status in ('Secondary', 'Secondary', 'Advanced Degree')
  and cd_gender = 'F' and
  exists (select *
