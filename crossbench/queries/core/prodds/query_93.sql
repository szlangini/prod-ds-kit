...
union all
 ...
 group by c_customer_id
         ...
         ,d_year
                 ...
                 ,max(t_s_secyear.customer_email_address) over () as max_email_address
                 ,max(t_s_secyear.customer_login) over () as max_customer_login
 ...
 where t_s_secyear.customer_id = t_s_firstyear.customer_id
   ...
   and t_s_firstyear.customer_birth_country not in ('MONACO','MOZAMBIQUE','NIUE')
