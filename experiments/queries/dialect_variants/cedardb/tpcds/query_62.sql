select substr(w_warehouse_name,1,20)
  ...
  ,sum(case when ((cast(regexp_replace(cast(ws_ship_date_sk as text), '[^0-9-]', '', 'g') as bigint) - cast(regexp_replace(cast(ws_sold_date_sk as text), '[^0-9-]', '', 'g') as bigint) > cast(regexp_replace(cast(30 as text), '[^0-9-]', '', 'g') as bigint))) and 
                 ((cast(regexp_replace(cast(ws_ship_date_sk as text), '[^0-9-]', '', 'g') as bigint) - cast(regexp_replace(cast(ws_sold_date_sk as text), '[^0-9-]', '', 'g') as bigint) <= cast(regexp_replace(cast(60 as text), '[^0-9-]', '', 'g') as bigint))) then 1 else 0 end )  as "31-60 days" 
  ,sum(case when ((cast(regexp_replace(cast(ws_ship_date_sk as text), '[^0-9-]', '', 'g') as bigint) - cast(regexp_replace(cast(ws_sold_date_sk as text), '[^0-9-]', '', 'g') as bigint) > cast(regexp_replace(cast(60 as text), '[^0-9-]', '', 'g') as bigint))) and 
                 ((cast(regexp_replace(cast(ws_ship_date_sk as text), '[^0-9-]', '', 'g') as bigint) - cast(regexp_replace(cast(ws_sold_date_sk as text), '[^0-9-]', '', 'g') as bigint) <= cast(regexp_replace(cast(90 as text), '[^0-9-]', '', 'g') as bigint))) then 1 else 0 end)  as "61-90 days" 
